...
def interactive_creator():
    """Mapa Interactivo."""
    return send_file(Path(__file__).parent / "interactive_updated.html")
        ...
        <form id="imageForm">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <small style="color: #666; font-size: 0.8rem; margin-top: 0.25rem;">
                        900+ DPI pueden tardar varios minutos y generar archivos grandes
                    </small>
                </div>
            </div>
...
def generate_image():
    ...
    try:
        ...
        fig, filename, stats = crear_imagen_mapa(num_circulos, divisiones, tipo_mapeo, mostrar_tipos, dpi)
